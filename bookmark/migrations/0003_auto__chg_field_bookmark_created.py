...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bookmark.created'
        db.alter_column(u'bookmark_bookmark', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Bookmark.created'
        db.alter_column(u'bookmark_bookmark', 'created', self.gf('django.db.models.fields.DateTimeField')())
