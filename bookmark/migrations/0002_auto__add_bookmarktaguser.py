...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookmarkTagUser'
        db.create_table(u'bookmark_bookmarktaguser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tag.Tag'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('bookmark_list', self.gf('dbarray.IntegerArrayField')()),
        ))
        db.send_create_signal(u'bookmark', ['BookmarkTagUser'])


    def backwards(self, orm):
        # Deleting model 'BookmarkTagUser'
        db.delete_table(u'bookmark_bookmarktaguser')
    ...
    models = {
        ...
        u'bookmark.bookmarktaguser': {
            'Meta': {'object_name': 'BookmarkTagUser'},
        ...
        u'tag.tag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
