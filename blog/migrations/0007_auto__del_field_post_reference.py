...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.reference'
        db.delete_column('blog_post', 'reference_id')


    def backwards(self, orm):
        # Adding field 'Post.reference'
        db.add_column('blog_post', 'reference',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reference_id', null=True, to=orm['blog.Post'], blank=True),
                      keep_default=False)
