...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_tag', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 25, 0, 0))),
        ))
        ...
        db.create_table('blog_post', (
            ...
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reference_id', null=True, to=orm['blog.Post'])),
