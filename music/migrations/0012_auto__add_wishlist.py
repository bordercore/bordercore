...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'music_wishlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 21, 0, 0))),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('song', self.gf('django.db.models.fields.TextField')(null=True)),
            ('artist', self.gf('django.db.models.fields.TextField')(null=True)),
            ('album', self.gf('django.db.models.fields.TextField')(null=True)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'music', ['WishList'])


    def backwards(self, orm):
        # Deleting model 'WishList'
        db.delete_table(u'music_wishlist')
    ...
    models = {
        ...
        u'music.album': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
