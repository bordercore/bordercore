...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.new_compilation'
        db.add_column(u'music_album', 'new_compilation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Album.compilation'
        db.alter_column(u'music_album', 'compilation', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Deleting field 'Album.new_compilation'
        db.delete_column(u'music_album', 'new_compilation')


        # Changing field 'Album.compilation'
        db.alter_column(u'music_album', 'compilation', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        u'music.album': {
            ...
            'new_compilation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
