...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.times_played'
        db.alter_column(u'music_song', 'times_played', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Song.times_played'
        db.alter_column(u'music_song', 'times_played', self.gf('django.db.models.fields.IntegerField')())
