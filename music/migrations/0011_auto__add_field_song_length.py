...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.length'
        db.add_column(u'music_song', 'length',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.length'
        db.delete_column(u'music_song', 'length')
    ...
    models = {
        ...
        u'tag.tag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
