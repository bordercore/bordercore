...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'music_song', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['music.Album'], null=True))

    def backwards(self, orm):

        # Changing field 'Song.album'
        db.alter_column(u'music_song', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['music.Album']))
