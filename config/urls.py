...
from accounts.views import ChangePasswordView, UserProfileUpdateView
...
urlpatterns = [
    ...
    path('drill/study/random', drill_views.study_random, name='study_random'),
    ...
    path('prefs/password', ChangePasswordView.as_view(), name='password'),
