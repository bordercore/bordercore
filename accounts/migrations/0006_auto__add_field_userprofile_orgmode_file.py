...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.orgmode_file'
        db.add_column(u'accounts_userprofile', 'orgmode_file',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.orgmode_file'
        db.delete_column(u'accounts_userprofile', 'orgmode_file')
    ...
    models = {
        ...
        u'tag.tag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
