...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.rss_feeds'
        db.alter_column(u'accounts_userprofile', 'rss_feeds', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'tag.tag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
