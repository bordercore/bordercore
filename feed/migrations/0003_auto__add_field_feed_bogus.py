...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.bogus'
        db.add_column('feed_feed', 'bogus',
                      self.gf('django.db.models.fields.TextField')(default='Bogus'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.bogus'
        db.delete_column('feed_feed', 'bogus')
    ...
    models = {
        'feed.feed': {
            ...
            'bogus': ('django.db.models.fields.TextField', [], {'default': "'Bogus'"}),
