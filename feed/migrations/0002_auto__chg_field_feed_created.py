...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feed_feed', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Feed.created'
        db.alter_column('feed_feed', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
