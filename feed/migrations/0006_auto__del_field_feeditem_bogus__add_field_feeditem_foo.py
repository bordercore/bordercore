...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedItem.bogus'
        db.delete_column('feed_feeditem', 'bogus')
    ...
    def backwards(self, orm):
        # Adding field 'FeedItem.bogus'
        db.add_column('feed_feeditem', 'bogus',
    ...
    models = {
        ...
        'feed.feeditem': {
            ...
            'foo': ('django.db.models.fields.IntegerField', [], {'default': '42'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
