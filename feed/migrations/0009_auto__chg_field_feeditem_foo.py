...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedItem.foo'
        db.alter_column('feed_feeditem', 'foo', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'FeedItem.foo'
        db.alter_column('feed_feeditem', 'foo', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'feed.feeditem': {
            ...
            'foo': ('django.db.models.fields.IntegerField', [], {'default': '42', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
