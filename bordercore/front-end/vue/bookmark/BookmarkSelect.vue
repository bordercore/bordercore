                    ...
                    <div class="d-flex flex-column">
                        ...
                        <form v-else @submit.prevent>
                            ...
                            <div class="row">
                                <div class="col-lg-11 offset-lg-1 d-flex">
                                    <div class="d-flex flex-column">
                                        <div v-if="gettingTitle" class="spinner-border ml-2" role="status">
                                            <span class="sr-only">Loading...</span>
                                        </div>
                                        <div class="mt-2 pl-1 text-info">
                                            {{ message }}
                                        </div>
                                    ...
                                    <div class="ml-auto">
                                        <button v-if="!hideAddButton" type="button" class="btn btn-primary mr-2" @click="onAdd">
                                            Add
                                        </button>
