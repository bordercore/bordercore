...
urlpatterns = [
    ...
    url(r'^blob/todo', blob_views.blob_todo, name='blob_todo'),
    ...
    url(r'^bookshelf/add', bookshelf_views.add_to_bookshelf, name='add_to_bookshelf'),
    url(r'^bookshelf/sort', bookshelf_views.sort_bookshelf, name='sort_bookshelf'),
    url(r'^bookshelf/remove', bookshelf_views.remove_from_bookshelf, name='remove_from_bookshelf'),
...
# urlpatterns += url(r'^$|^index.html', homepage_views.homepage, name='homepage'),
