...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'document_document', (
            ...
            ('author', self.gf('dbarray.fields.TextArrayField')(blank=True)),
        ...
        db.create_table(u'document_document_tags', (
        ...
        db.create_unique(u'document_document_tags', ['document_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('document_document_tags')
